      ...
      <div className="sudo-container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12  items-start">
          ...
          <div>
            <div className="">
              <div className=" w-fit">
                <h4 className="uppercase font-bold">Have Question?</h4>
                <div className="w-2/4">
                  <LineAnimation />
                </div>
              </div>
              <h2 className="text-sudo-title-48 text-sudo-neutral-6 font-heading ">FAQ
              </h2>
            </div>
            ...
            <AccordionItem
              ...
              questionClassName="font-bold font-heading hover:bg-blue-50" // Custom question colors
            />
          </div>
