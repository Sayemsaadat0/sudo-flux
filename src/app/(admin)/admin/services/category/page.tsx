...
const mockCategories = [
  {
    id: 1,
    name: "Development",
    description: "Software development services including web, mobile, and custom applications",
    services: 8,
    status: "Active",
    date: "2024-01-15",
    color: "#8B5CF6",
    featured: true,
    skills: ["React", "Node.js", "Python", "Java", "Swift", "Kotlin"],
    revenue: "$125,000"
  },
  {
    id: 2,
    name: "Marketing",
    description: "Digital marketing and advertising services for business growth",
    services: 6,
    status: "Active",
    date: "2024-01-10",
    color: "#10B981",
    featured: true,
    skills: ["SEO", "PPC", "Social Media", "Content Marketing", "Email Marketing"],
    revenue: "$89,000"
  },
  {
    id: 3,
    name: "Design",
    description: "Creative design services including UI/UX, graphic design, and branding",
    services: 4,
    status: "Active",
    date: "2024-01-08",
    color: "#EC4899",
  ...
  },
  {
    id: 4,
    name: "Infrastructure",
    description: "Cloud infrastructure, DevOps, and technical consulting services",
    services: 3,
    status: "Active",
    date: "2024-01-20",
    color: "#F59E0B",
  ...
  },
  {
    id: 5,
    name: "Consulting",
    description: "Business and technology consulting for digital transformation",
    services: 5,
    status: "Inactive",
    date: "2024-01-05",
    color: "#3B82F6",
    featured: false,
    skills: ["Strategy", "Digital Transformation", "Process Optimization", "Analytics"],
    revenue: "$203,000"
  }
]
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sudo-neutral-3 text-sm">
                Manage service categories and their associated skills
              </p>
            </div>
            ...
            <table className="w-full">
              <thead className="bg-sudo-white-1 border-b border-sudo-white-2">
                <tr>
                  ...
                  <th className="text-left py-3 px-4 font-semibold text-sudo-neutral-5 text-sm">Revenue</th>
