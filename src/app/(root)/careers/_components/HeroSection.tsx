          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <div className="flex flex-col justify-start items-start w-fit">
                <h4 className="uppercase font-bold text-sudo-purple-6 mb-2">Join Our Team</h4>
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="bg-sudo-white-2/80 backdrop-blur-sm border border-sudo-white-3 rounded-2xl p-6 text-center group hover:bg-sudo-white-2 hover:shadow-lg transition-all duration-300">
                <div className="text-4xl font-bold text-sudo-purple-6 mb-2 group-hover:scale-110 transition-transform duration-300">100%</div>
                <div className="text-sudo-neutral-4 text-sm font-medium">Remote Friendly</div>
                <div className="text-sudo-neutral-3 text-xs mt-1">Work from anywhere</div>
              </div>
              <div className="bg-sudo-white-2/80 backdrop-blur-sm border border-sudo-white-3 rounded-2xl p-6 text-center group hover:bg-sudo-white-2 hover:shadow-lg transition-all duration-300">
                <div className="text-4xl font-bold text-sudo-blue-6 mb-2 group-hover:scale-110 transition-transform duration-300">25+</div>
                <div className="text-sudo-neutral-4 text-sm font-medium">Paid Days Off</div>
                <div className="text-sudo-neutral-3 text-xs mt-1">Plus holidays</div>
              </div>
              <div className="bg-sudo-white-2/80 backdrop-blur-sm border border-sudo-white-3 rounded-2xl p-6 text-center group hover:bg-sudo-white-2 hover:shadow-lg transition-all duration-300">
                <div className="text-4xl font-bold text-sudo-purple-6 mb-2 group-hover:scale-110 transition-transform duration-300">$5K</div>
                <div className="text-sudo-neutral-4 text-sm font-medium">Learning Budget</div>
                <div className="text-sudo-neutral-3 text-xs mt-1">Annual allowance</div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-4 bg-sudo-white-2/80 backdrop-blur-sm border border-sudo-white-3 rounded-2xl hover:bg-sudo-white-2 hover:shadow-lg transition-all duration-300">
                ...
                <div>
                  <h4 className="font-semibold text-sudo-neutral-6">Inclusive Culture</h4>
                  <p className="text-sudo-neutral-4 text-sm">Diverse and welcoming environment</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 bg-sudo-white-2/80 backdrop-blur-sm border border-sudo-white-3 rounded-2xl hover:bg-sudo-white-2 hover:shadow-lg transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-sudo-neutral-4 text-sm">Work-life balance matters</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-sudo-white-2/80 backdrop-blur-sm border border-sudo-white-3 rounded-2xl p-6">
              <h4 className="text-sudo-neutral-6 font-semibold mb-3">Our Values:</h4>
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-sudo-purple-6 rounded-full"></div>
                  <span className="text-sudo-neutral-4 text-sm">Innovation and creativity</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-sudo-blue-6 rounded-full"></div>
                  <span className="text-sudo-neutral-4 text-sm">Collaboration and teamwork</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-sudo-purple-6 rounded-full"></div>
                  <span className="text-sudo-neutral-4 text-sm">Continuous learning</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-sudo-blue-6 rounded-full"></div>
                  <span className="text-sudo-neutral-4 text-sm">Customer success focus</span>
                </div>
              </div>
            </div>
          </div>
